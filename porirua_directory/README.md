...
**Site chrome:** Top nav logo and **Your Porirua Directory** title both return to the directory landing. **My list** appears once something is saved (count in the label). **About** is always in the nav. On browse, **← Back** appears left of About, and a **Find support | Connect with community** switch stays in the header.
...
**Landing:** Te reo welcome, a search that looks across both paths, popular topic shortcuts, and two **path cards** (**Find support** / **Connect with community**). Those cards enter browse; the same labels stay in the header so people can switch without starting over. A compact **Urgent help** bar (111, 105, 1737, Women's Refuge) is fixed to the bottom of the viewport on every page (including About).
