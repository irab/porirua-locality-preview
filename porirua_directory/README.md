...
**Target URL:** [https://directory.bsky.nz](https://directory.bsky.nz) (Cloudflare `bsky.nz` → blackbox nginx). See [MVP runbook](../docs/MVP-RUNBOOK.md) and blackbox prod tenant `porirua-directory` (Milestone D — not wired yet).
