...
Commit **`data/services.json`** when publishing; **`data/fsd-porirua.raw.json`** and **`data/fsd-porirua-excluded.json`** are regenerated by `npm run import:fsd` and are gitignored.
