...
porirua_directory/
  ...
  directory.css
  scripts/                # FSD import + merge + Phase 2 catalog (schema, bootstrap, publish)
  directus/               # snapshot, Flows, operations sidecar for the editor workspace
