...
5. When you leave **Name**, we look for a similar organisation — including ones off the site. **Open the existing one** or **Create anyway**.
...
- **Details changed** — field rows like `Phone: 04 237 7749 → 04 237 9608`
- **New service**
- **Gone from the government list**
- **Check the map pin** — the map, not a pair of numbers
