...
| What | Value that day |
|------|----------------|
| App tree this document was written against | `76e939e` (`feature/payload-directory-ed-oi4` — Payload `image-dev` pin) |
...
| directory-dev Payload pin | `76e939e27389a029bf918c26f01bdd17df9d04a6` — `ghcr.io/irab/porirua-directory-payload` only |
...
**Running version** = the SHA in the blackbox pin, not “whatever is on `main`”, and not necessarily this repo’s HEAD. On 8 Sep 2026 directory-dev catalog/Directus/sidecar ran `b65e5d7` while Payload was pinned separately at `76e939e`.
